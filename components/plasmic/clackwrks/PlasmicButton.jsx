...
import sty from "./PlasmicButton.module.css"; // plasmic-import: yN0iPoaTD0P/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: Q8GGippUpY8/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: Wm92nBReP3i/icon
...
function PlasmicButton__RenderFunc(props) {
  ...
  return (
    ...
    >
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__yohYl)}
                role={"img"}
              />
            ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: <p.Trans>{"Button"}</p.Trans>,
          value: args.children,
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__jh64Z)}
                role={"img"}
              />
            ),
