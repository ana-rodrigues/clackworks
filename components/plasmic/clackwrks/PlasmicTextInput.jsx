...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: LvGLACoIrmm/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: DrPWPW85Y_A/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__hzdX)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__x2WO2)}
                role={"img"}
              />
            ),
